...
JOOD_RESPONSE_SCHEMA = {
    ...
    "properties": {
        ...
        "action": {
            ...
            "enum": [
                "pitch_product",
                "send_catalog_options",
                "send_product_link",
                "send_selected_option",
                "answer",
                "close",
                "handoff",
            ],
...
- في البيع الصادر لا تبدئي بسؤال العميل عن الفئة؛ قدّمي أولًا منتجًا حقيقيًا من كتالوج سلة وسعره وفائدته وحافزًا معتمدًا، ثم سؤال شراء واحدًا.
- عند الموافقة نفّذي الوعد أو الإجراء فورًا. عند «الثاني» أو رقم خيار استخدمي presented_options المحفوظة. عند رفض العرض انتقلي لمنتج حقيقي آخر.
- action هو أمر تنفيذي للـBackend: pitch_product لعرض منتج، send_product_link لإرسال منتج محدد، send_catalog_options لعرض عدة خيارات، send_selected_option لاختيار رقم محفوظ، answer للإجابة، close للرفض، handoff للتحويل.
