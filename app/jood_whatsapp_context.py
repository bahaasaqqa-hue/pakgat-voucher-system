...
وإذا حابين تبدأون إجراءات التسجيل من الآن 👇
بوابة شركاء بكجات:
https://merchant.pakgat.com/merchant/register

من خلالها تكملون بيانات المنشأة، ترفعون المستندات الرسمية، وتستكملون التحقق عبر نفاذ، وبعدها يراجع فريق بكجات الطلب ويتم إشعاركم بنتيجة الاعتماد.

وإذا احتجتم أي مساعدة أثناء التسجيل، أنا معكم 🌷
