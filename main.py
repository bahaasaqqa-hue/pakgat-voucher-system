...
from app import jood_voice_bridge_ui as _jood_voice_bridge_ui  # noqa: F401 - canonical Phone Link/Voicemeeter voice bridge route
from app import jood_voice_server_tts as _jood_voice_server_tts  # noqa: F401 - server-backed Zariyah TTS endpoint
...
from app import jood_voice_live_bridge as _jood_voice_live_bridge  # noqa: F401 - B1 MediaRecorder capture + automatic Jood call flow
from app import jood_voice_self_test_page as _jood_voice_self_test_page  # noqa: F401 - standalone physical-speaker Zariyah self-test
